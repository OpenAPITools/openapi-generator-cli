...
```json5
{
  ...
  "spaces": 2,
  "generator-cli": {
    "version": "7.7.0" // or the current latest version ;)
  }
}
```
...
- the generator-cli version 7.7.0 is used
...
npm i @openapitools/openapi-generator-cli@2.9.0                                         
```
...
yarn add @openapitools/openapi-generator-cli@2.9.0
```
